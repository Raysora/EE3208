...
DATA_SEG SEGMENT
	...
	STRING_SETQ			DB	13,10,'SetQ'
	STRING_SETP			DB	13,10,'SetP'

	STRING_TOTAL		DB	'Total     '
	STRING_PAID			DB	'Paid      '
	STRING_CHANGE		DB	'Change    '
	...
	SER_STATE			DB	00h
	SER_STATE_IDLE		EQU	00h
	SER_STATE_QTYITEM	EQU	01h
	SER_STATE_QTY		EQU	02h
	SER_STATE_PXITEM	EQU	03h
	SER_STATE_PX		EQU	04h
...
M_TXN_REPOLL:
	...
	MOV AL, DS:KEYPAD_QUEUE_TAIL
	CMP AL, DS:KEYPAD_QUEUE_HEAD
	JAE M_TXN_QUEUE_RESET
	STI ; unlock mutex
	JMP M_TXN_PROCESS_KEY
M_TXN_QUEUE_RESET:
	MOV DS:KEYPAD_QUEUE_HEAD, 0
	MOV DS:KEYPAD_QUEUE_TAIL, 0
	STI ; unlock mutex
...
M_TXN_NEXTPROD:
	...
	DEC SI
	SHL SI, 1
	MOV SI, DS:PRODUCT_NAMES[SI]

	MOV DS:SER_STR_ADDR, OFFSET STRING_CRLF
	MOV DS:SER_STR_LEN, 2
	CALL NEAR PTR SER_STR_WR

	MOV DS:SER_STR_ADDR, SI
	MOV DS:SER_STR_LEN, 12
	CALL NEAR PTR SER_STR_WR

	MOV DS:SER_STR_ADDR, OFFSET STRING_0x
	MOV DS:SER_STR_LEN, 2
	CALL NEAR PTR SER_STR_WR
...
M_TXN_TTLLOOP:
	...
	MOV DS:SER_STR_ADDR, OFFSET STRING_TOTAL
	MOV DS:SER_STR_LEN, 10
	CALL NEAR PTR SER_STR_WR
...
CHANGE_ENTERED:
	...
	MOV DS:SER_STR_ADDR, OFFSET STRING_PAID
	MOV DS:SER_STR_LEN, 10
	CALL NEAR PTR SER_STR_WR
	...
	MOV DS:SER_STR_ADDR, OFFSET STRING_CHANGE
	MOV DS:SER_STR_LEN, 10
	CALL NEAR PTR SER_STR_WR
...
M_QRY_REPOLL:
	...
	MOV AL, DS:KEYPAD_QUEUE_TAIL
	CMP AL, DS:KEYPAD_QUEUE_HEAD
	JAE M_QRY_QUEUE_RESET
	STI ; unlock mutex
	JMP M_QRY_PROCESS_KEY
M_QRY_QUEUE_RESET:
	MOV DS:KEYPAD_QUEUE_HEAD, 0
	MOV DS:KEYPAD_QUEUE_TAIL, 0
	STI ; unlock mutex
...
UPDATE_CASH_DISPLAY PROC NEAR
	...
	MOV BX, 6
UPDATE_DISPLAY_CASH_CLR:
	MOV DS:LED_VALS[BX][-1], LED_BLANK
	DEC BX
	JNZ UPDATE_DISPLAY_CASH_CLR
...
SER_STR_WR PROC NEAR
	...
	XOR CH, CH
	MOV CL, DS:SER_STR_LEN
	MOV SI, DS:SER_STR_ADDR
	MOV BX, 0
...
SERIAL_REC_ACTION PROC FAR
	...
	CMP DS:SER_STATE, SER_STATE_QTYITEM
	JE SER_QTY_ITEM

	CMP DS:SER_STATE, SER_STATE_QTY
	JE SER_QTY2FAR

	CMP DS:SER_STATE, SER_STATE_PXITEM
	JE SER_PX_ITEM2FAR

	CMP DS:SER_STATE, SER_STATE_PX
	JE SER_PX2FAR
...
SER_IDLE:
	...
	CMP AL, '='
	JNE SER_NOT_EQ
	MOV DS:SER_STATE, SER_STATE_QTYITEM
	MOV DS:SER_STR_ADDR, OFFSET STRING_SETQ
	MOV DS:SER_STR_LEN, 6
	CALL NEAR PTR SER_STR_WR
	JMP SER_RET
SER_NOT_EQ:
	...
	CMP AL, '$'
	JNE SER_NOT_DL
	MOV DS:SER_STATE, SER_STATE_PXITEM
	MOV DS:SER_STR_ADDR, OFFSET STRING_SETP
	MOV DS:SER_STR_LEN, 6
	CALL NEAR PTR SER_STR_WR
SER_NOT_DL:
...
SER_QTYI_FIN:
	MOV DS:SER_STATE, SER_STATE_QTY
	JMP SER_RET
...
SER_QTY_FIN:
	...
	MOV DS:SER_STATE, SER_STATE_IDLE
	JMP SER_RET
